...
public class Test {
    ...
    public static void main( String[] args ) throws InterruptedException {
        ...
        webDriver.findElement(By.xpath("/html/body/div/div/div[1]/div[1]/div/div[3]/div/form/div/div[2]/div/input")).sendKeys("abcd");
        Thread.sleep(1000);
        webDriver.findElement(By.xpath("/html/body/div/div/div[1]/div[1]/div/div[3]/div/form/div/div[3]/div/input")).sendKeys("GHJ");
        Thread.sleep(1000);
        webDriver.findElement(By.xpath("/html/body/div/div/div[1]/div[1]/div/div[3]/div/form/div/div[4]/div/input")).sendKeys("abcd@abc.com.tr");
        Thread.sleep(1000);
